...
fn map_stream_info(stream: FfprobeStream) -> MediaStreamInfo {
    MediaStreamInfo {
        ...
        frame_rate: display_frame_rate(stream.avg_frame_rate.clone(), stream.r_frame_rate.clone()),
        avg_frame_rate: stream.avg_frame_rate.unwrap_or_default(),
        r_frame_rate: stream.r_frame_rate.unwrap_or_default(),
